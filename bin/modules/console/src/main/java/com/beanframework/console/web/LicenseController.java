...
public class LicenseController extends AbstractController {
  ...
  public String view(
      @Valid @ModelAttribute(LicenseWebConstants.ModelAttribute.LICENSE) ConfigurationDto configuration,
      Model model, @RequestParam Map<String, Object> allRequestParams,
