...
public class CreateModule {
  ...
  private void createClassPathModule(VelocityContext context, String moduleartifact,
  ...
  private void createConstants(VelocityContext context, String moduleartifact, String modulegroup,
      String location) throws IOException {
    String path = location + File.separator + moduleartifact + File.separator + "src/main/java/"
        + modulegroup.replace(".", "/") + File.separator + moduleartifact;
    ...
    File moduleEntity = new File(path + File.separator
        + StringUtils.capitalize(moduleartifact.toLowerCase()) + "Constants.java");
    FileUtils.write(moduleEntity, writer.toString(), StandardCharsets.UTF_8.name());
    System.out.println("Written: " + moduleEntity.getPath());
  }

  // sample\src\main\java\com\beanframework\sample\domain\Sample.java
  private void createDomain(VelocityContext context, String moduleartifact, String modulegroup,
      String location) throws IOException {
    String path = location + File.separator + moduleartifact + File.separator + "src/main/java/"
        + modulegroup.replace(".", "/") + File.separator + moduleartifact + File.separator
        + "domain";
    ...
    File moduleEntity = new File(
        path + File.separator + StringUtils.capitalize(moduleartifact.toLowerCase()) + ".java");
    FileUtils.write(moduleEntity, writer.toString(), StandardCharsets.UTF_8.name());
    System.out.println("Written: " + moduleEntity.getPath());
  }
}
