...
public class ImexConstants {
  ...
  public static final String IMEX_IMPORT_INIT_LOCATIONS =
      "#{'${module.imex.import.init.locations}'.split(',')}";
  public static final String IMEX_IMPORT_UPDATE_LOCATIONS =
      "#{'${module.imex.import.update.locations}'.split(',')}";
}
