...
import com.beanframework.backoffice.api.data.VendorDataTableResponseData;
...
public class VendorResource extends AbstractResource {
  ...
  @PreAuthorize(VendorPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = VendorWebConstants.Path.Api.VENDOR, method = RequestMethod.GET,
  ...
  @PreAuthorize(VendorPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = VendorWebConstants.Path.Api.VENDOR_HISTORY, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest, vendorFacade.findHistory(dataTableRequest),
        vendorFacade.countHistory(dataTableRequest));
  }
}
