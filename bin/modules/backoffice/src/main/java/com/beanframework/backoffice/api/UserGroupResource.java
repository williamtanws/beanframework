...
import com.beanframework.backoffice.api.data.UserGroupDataTableResponseData;
...
public class UserGroupResource extends AbstractResource {
  ...
  @PreAuthorize(UserGroupPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = UserGroupWebConstants.Path.Api.USERGROUP, method = RequestMethod.GET,
  ...
  public DataTableResponse<DataTableResponseData> page(HttpServletRequest request)
    ...
    Page<UserGroupDto> pagination = userGroupFacade.findPage(dataTableRequest);

    DataTableResponse<DataTableResponseData> dataTableResponse =
        new DataTableResponse<DataTableResponseData>();
    dataTableResponse.setDraw(dataTableRequest.getDraw());
    dataTableResponse.setRecordsTotal(userGroupFacade.count());
  ...
  @PreAuthorize(UserGroupPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = UserGroupWebConstants.Path.Api.USERGROUP_HISTORY,
  ...
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest, userGroupFacade.findHistory(dataTableRequest),
        userGroupFacade.countHistory(dataTableRequest));
  }
}
