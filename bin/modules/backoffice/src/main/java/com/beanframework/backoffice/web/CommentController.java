...
public class CommentController extends AbstractController {
  ...
  public String page(
      @Valid @ModelAttribute(CommentWebConstants.ModelAttribute.COMMENT_DTO) CommentDto commentDto,
  ...
  public RedirectView create(
    ...
    if (commentDto.getUuid() != null) {
      ...
      try {
        commentDto = commentFacade.save(commentDto);
  ...
  public RedirectView delete(
      @Valid @ModelAttribute(CommentWebConstants.ModelAttribute.COMMENT_DTO) CommentDto dto,
      Model model, BindingResult bindingResult, @RequestParam Map<String, Object> requestParams,
      RedirectAttributes redirectAttributes) {
