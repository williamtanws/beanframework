...
import com.beanframework.backoffice.api.data.EnumerationDataTableResponseData;
...
public class EnumerationResource extends AbstractResource {
  ...
  @PreAuthorize(EnumerationPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = EnumerationWebConstants.Path.Api.ENUMERATION, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<EnumerationDataTableResponseData> page(HttpServletRequest request)
      throws Exception {
    ...
    DataTableResponse<EnumerationDataTableResponseData> dataTableResponse =
        new DataTableResponse<EnumerationDataTableResponseData>();
  ...
  @PreAuthorize(EnumerationPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = EnumerationWebConstants.Path.Api.ENUMERATION_HISTORY,
  ...
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest,
        enumerationFacade.findHistory(dataTableRequest),
        enumerationFacade.countHistory(dataTableRequest));
  }
}
