...
public class UserResource extends AbstractResource {
  ...
  @PreAuthorize(UserPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = UserWebConstants.Path.Api.USER, method = RequestMethod.GET,
  ...
  @PreAuthorize(UserPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = UserWebConstants.Path.Api.USER_HISTORY, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest, userFacade.findHistory(dataTableRequest),
        userFacade.countHistory(dataTableRequest));
  }
}
