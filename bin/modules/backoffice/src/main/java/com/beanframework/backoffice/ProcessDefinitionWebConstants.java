...
public interface ProcessDefinitionWebConstants {
	...
	public interface Path {
		...
		public interface Api {
			...
			public static final String PROCESSDEFINITION_HISTORY = "${path.api.processdefinition.history}";
			public static final String PROCESSDEFINITION_CHECKID = "${path.api.processdefinition.checkid}";
		}
