...
public class DynamicFieldSlotResource extends AbstractResource {
  ...
  @PreAuthorize(DynamicFieldSlotPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = DynamicFieldSlotWebConstants.Path.Api.DYNAMICFIELDSLOT,
      method = RequestMethod.GET, produces = "application/json")
  @ResponseBody
  public DataTableResponse<DynamicFieldSlotDataTableResponseData> page(HttpServletRequest request)
      throws Exception {
    ...
    DataTableResponse<DynamicFieldSlotDataTableResponseData> dataTableResponse =
        new DataTableResponse<DynamicFieldSlotDataTableResponseData>();
  ...
  @PreAuthorize(DynamicFieldSlotPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = DynamicFieldSlotWebConstants.Path.Api.DYNAMICFIELDSLOT_HISTORY,
      method = RequestMethod.GET, produces = "application/json")
  @ResponseBody
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest,
        dynamicFieldSlotFacade.findHistory(dataTableRequest),
        dynamicFieldSlotFacade.countHistory(dataTableRequest));
  }
}
