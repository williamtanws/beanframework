...
public class DynamicFieldTemplateResource extends AbstractResource {
  ...
  @PreAuthorize(DynamicFieldTemplatePreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = DynamicFieldTemplateWebConstants.Path.Api.DYNAMICFIELDTEMPLATE,
  ...
  public DataTableResponse<DataTableResponseData> page(HttpServletRequest request)
    ...
    Page<DynamicFieldTemplateDto> pagination =
        dynamicFieldTemplateFacade.findPage(dataTableRequest);
  ...
  @PreAuthorize(DynamicFieldTemplatePreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = DynamicFieldTemplateWebConstants.Path.Api.DYNAMICFIELDTEMPLATE_HISTORY,
      method = RequestMethod.GET, produces = "application/json")
  @ResponseBody
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest,
        dynamicFieldTemplateFacade.findHistory(dataTableRequest),
        dynamicFieldTemplateFacade.countHistory(dataTableRequest));
  }
}
