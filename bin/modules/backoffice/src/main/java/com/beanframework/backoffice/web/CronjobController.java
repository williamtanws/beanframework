...
public class CronjobController extends AbstractController {
  ...
  public String page(
      @Valid @ModelAttribute(CronjobWebConstants.ModelAttribute.CRONJOB_DTO) CronjobDto cronjobDto,
  ...
  public RedirectView create(
    ...
    if (cronjobDto.getUuid() != null) {
      ...
      try {
        cronjobDto = cronjobFacade.save(cronjobDto);
  ...
  public RedirectView delete(
      @Valid @ModelAttribute(CronjobWebConstants.ModelAttribute.CRONJOB_DTO) CronjobDto dto,
      Model model, BindingResult bindingResult, @RequestParam Map<String, Object> requestParams,
      RedirectAttributes redirectAttributes) {
