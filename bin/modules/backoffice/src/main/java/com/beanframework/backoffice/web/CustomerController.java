...
public class CustomerController extends AbstractController {
  ...
  public String page(
      @Valid @ModelAttribute(CustomerWebConstants.ModelAttribute.CUSTOMER_DTO) CustomerDto employeeDto,
  ...
  public RedirectView delete(
      @Valid @ModelAttribute(CustomerWebConstants.ModelAttribute.CUSTOMER_DTO) CustomerDto dto,
      Model model, BindingResult bindingResult, @RequestParam Map<String, Object> requestParams,
      RedirectAttributes redirectAttributes) {
