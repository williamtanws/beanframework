...
public class VendorController extends AbstractController {
	...
	public String page(@Valid @ModelAttribute(VendorWebConstants.ModelAttribute.VENDOR_DTO) VendorDto vendorDto, Model model, @RequestParam Map<String, Object> requestParams) throws Exception {
		return VIEW_VENDOR;
	}

	@PreAuthorize(VendorPreAuthorizeEnum.HAS_READ)
	@GetMapping(value = VendorWebConstants.Path.VENDOR_FORM)
	public String form(@Valid @ModelAttribute(VendorWebConstants.ModelAttribute.VENDOR_DTO) VendorDto vendorDto, Model model) throws Exception {
	...
	public RedirectView delete(@Valid @ModelAttribute(VendorWebConstants.ModelAttribute.VENDOR_DTO) VendorDto dto, Model model, BindingResult bindingResult,
			@RequestParam Map<String, Object> requestParams, RedirectAttributes redirectAttributes) {
