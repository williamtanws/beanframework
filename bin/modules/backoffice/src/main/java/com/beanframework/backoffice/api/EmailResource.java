...
public class EmailResource extends AbstractResource {
	...
	@PreAuthorize(EmailPreAuthorizeEnum.HAS_READ)
	@RequestMapping(value = EmailWebConstants.Path.Api.EMAIL, method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	...
	@PreAuthorize(EmailPreAuthorizeEnum.HAS_READ)
	@RequestMapping(value = EmailWebConstants.Path.Api.EMAIL_HISTORY, method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
