...
public class CurrencyResource extends AbstractResource {
  ...
  @PreAuthorize(CurrencyPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = CurrencyWebConstants.Path.Api.CURRENCY, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<CurrencyDataTableResponseData> page(HttpServletRequest request)
      throws Exception {
    ...
    DataTableResponse<CurrencyDataTableResponseData> dataTableResponse =
        new DataTableResponse<CurrencyDataTableResponseData>();
  ...
  @PreAuthorize(CurrencyPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = CurrencyWebConstants.Path.Api.CURRENCY_HISTORY,
  ...
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest, currencyFacade.findHistory(dataTableRequest),
        currencyFacade.countHistory(dataTableRequest));
  }
}
