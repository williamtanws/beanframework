...
public class CompanyResource extends AbstractResource {
  ...
  @PreAuthorize(CompanyPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = CompanyWebConstants.Path.Api.COMPANY, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<CompanyDataTableResponseData> page(HttpServletRequest request)
      throws Exception {
    ...
    DataTableResponse<CompanyDataTableResponseData> dataTableResponse =
        new DataTableResponse<CompanyDataTableResponseData>();
  ...
  @PreAuthorize(CompanyPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = CompanyWebConstants.Path.Api.COMPANY_HISTORY, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest, companyFacade.findHistory(dataTableRequest),
        companyFacade.countHistory(dataTableRequest));
  }
}
