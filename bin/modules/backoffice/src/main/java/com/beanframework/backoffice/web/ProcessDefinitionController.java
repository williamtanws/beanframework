...
public class ProcessDefinitionController extends AbstractController {
	...
	public String page(@Valid @ModelAttribute(ProcessDefinitionWebConstants.ModelAttribute.PROCESSDEFINITION) ProcessDefinition processdefinition, Model model, @RequestParam Map<String, Object> requestParams) throws Exception {
		return VIEW_PROCESSDEFINITION;
	}

	@PreAuthorize(ProcessDefinitionPreAuthorizeEnum.HAS_READ)
	@GetMapping(value = ProcessDefinitionWebConstants.Path.PROCESSDEFINITION_FORM)
	public String form(@Valid @ModelAttribute(ProcessDefinitionWebConstants.ModelAttribute.PROCESSDEFINITION) ProcessDefinition processdefinition, Model model) throws Exception {

		processdefinition = processdefinitionFacade.findOneById(processdefinition.getId());
		model.addAttribute(ProcessDefinitionWebConstants.ModelAttribute.PROCESSDEFINITION, processdefinition);
