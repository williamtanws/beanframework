...
import com.beanframework.backoffice.api.data.RegionDataTableResponseData;
...
public class RegionResource extends AbstractResource {
  ...
  @PreAuthorize(RegionPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = RegionWebConstants.Path.Api.REGION, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<RegionDataTableResponseData> page(HttpServletRequest request)
      throws Exception {
    ...
    DataTableResponse<RegionDataTableResponseData> dataTableResponse =
        new DataTableResponse<RegionDataTableResponseData>();
  ...
  @PreAuthorize(RegionPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = RegionWebConstants.Path.Api.REGION_HISTORY, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest, regionFacade.findHistory(dataTableRequest),
        regionFacade.countHistory(dataTableRequest));
  }
}
