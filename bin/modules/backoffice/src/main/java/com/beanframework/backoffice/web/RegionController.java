...
public class RegionController extends AbstractController {
  ...
  public String page(
      @Valid @ModelAttribute(RegionWebConstants.ModelAttribute.REGION_DTO) RegionDto languageDto,
  ...
  public RedirectView delete(
      @Valid @ModelAttribute(RegionWebConstants.ModelAttribute.REGION_DTO) RegionDto dto,
      Model model, BindingResult bindingResult, @RequestParam Map<String, Object> requestParams,
      RedirectAttributes redirectAttributes) {
