...
import com.beanframework.backoffice.api.data.LanguageDataTableResponseData;
...
public class LanguageResource extends AbstractResource {
  ...
  @PreAuthorize(LanguagePreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = LanguageWebConstants.Path.Api.LANGUAGE, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<LanguageDataTableResponseData> page(HttpServletRequest request)
      throws Exception {
    ...
    DataTableResponse<LanguageDataTableResponseData> dataTableResponse =
        new DataTableResponse<LanguageDataTableResponseData>();
  ...
  @PreAuthorize(LanguagePreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = LanguageWebConstants.Path.Api.LANGUAGE_HISTORY,
  ...
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest, languageFacade.findHistory(dataTableRequest),
        languageFacade.countHistory(dataTableRequest));
  }
}
