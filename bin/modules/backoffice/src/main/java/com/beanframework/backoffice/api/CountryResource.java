...
import com.beanframework.backoffice.api.data.CountryDataTableResponseData;
...
public class CountryResource extends AbstractResource {
  ...
  @PreAuthorize(CountryPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = CountryWebConstants.Path.Api.COUNTRY, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<CountryDataTableResponseData> page(HttpServletRequest request)
      throws Exception {
    ...
    DataTableResponse<CountryDataTableResponseData> dataTableResponse =
        new DataTableResponse<CountryDataTableResponseData>();
  ...
  @PreAuthorize(CountryPreAuthorizeEnum.HAS_READ)
  @RequestMapping(value = CountryWebConstants.Path.Api.COUNTRY_HISTORY, method = RequestMethod.GET,
      produces = "application/json")
  @ResponseBody
  public DataTableResponse<HistoryDataTableResponseData> history(HttpServletRequest request)
    ...
    return historyDataTableResponse(dataTableRequest, countryFacade.findHistory(dataTableRequest),
        countryFacade.countHistory(dataTableRequest));
  }
}
