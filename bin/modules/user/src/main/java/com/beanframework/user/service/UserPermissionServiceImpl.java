...
public class UserPermissionServiceImpl implements UserPermissionService {
	...
	@Override
	public void generateUserPermissionFieldsOnInitialDefault(UserPermission model) throws Exception {
	...
	@Override
	public void generateUserPermissionFieldOnLoad(UserPermission model) throws Exception {
		Map<String, Object> properties = new HashMap<String, Object>();
		properties.put(Configuration.ID, CONFIGURATION_DYNAMIC_FIELD_TEMPLATE);
		Configuration configuration = modelService.findOneByProperties(properties, Configuration.class);
