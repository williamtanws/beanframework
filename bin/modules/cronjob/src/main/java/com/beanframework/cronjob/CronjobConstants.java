...
public final class CronjobConstants {
  ...
  public static interface Query {
    public static final String SELECT_CRONJOB_BY_STARTUP_BY_STATUS =
        "select c from Cronjob c where c.startup = 0 and (c.status = 'Continued' or c.status = 'RUNNING' or c.status = 'PAUSED')";
  }
