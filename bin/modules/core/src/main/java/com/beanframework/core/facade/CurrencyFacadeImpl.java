...
@Component
public class CurrencyFacadeImpl extends AbstractFacade<Currency, CurrencyDto>
    implements CurrencyFacade {

  private static final Class<Currency> entityClass = Currency.class;
