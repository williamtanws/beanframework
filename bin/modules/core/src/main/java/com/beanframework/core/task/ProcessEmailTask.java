...
public class ProcessEmailTask implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) {
    ...
    try {
      ...
      List<Email> oldEmails = modelService.findByPropertiesBySortByResult(oldProperties, oldSorts,
          null, null, Email.class);
      ...
      if (numberOfPendingEmails > 0) {
        ...
        List<Email> pendingEmails = modelService.findByPropertiesBySortByResult(pendingProperties,
            pendingSorts, null, null, Email.class);
      ...
      if (EMAIL_PROCESS_NUMBER == 0) {
        processingEmails = modelService.findByPropertiesBySortByResult(processingProperties,
            processingSorts, null, null, Email.class);
      } else {
        processingEmails = modelService.findByPropertiesBySortByResult(processingProperties,
            processingSorts, null, EMAIL_PROCESS_NUMBER, Email.class);
      }
