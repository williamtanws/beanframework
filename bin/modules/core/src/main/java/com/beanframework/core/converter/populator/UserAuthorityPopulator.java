...
@Component
public class UserAuthorityPopulator extends AbstractPopulator<UserAuthority, UserAuthorityDto>
    implements Populator<UserAuthority, UserAuthorityDto> {
  ...
  public UserRightAttributeDto populateUserRightField(UserRightAttribute source)
      throws PopulatorException {
    if (source == null)
      return null;
