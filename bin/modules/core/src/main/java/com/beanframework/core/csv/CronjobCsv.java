...
public class CronjobCsv extends GenericCsv {
  ...
  public String toString() {
    return "CronjobCsv [id=" + id + ", jobClass=" + jobClass + ", jobGroup=" + jobGroup
        + ", jobName=" + name + ", description=" + description + ", cronExpression="
        + cronExpression + ", startup=" + startup + ", jobTrigger=" + jobTrigger
        + ", triggerStartDate=" + triggerStartDate + ", parameters=" + parameters + "]";
  }
