...
public class DynamicFieldSlotRemoveInterceptor extends AbstractRemoveInterceptor<DynamicFieldSlot> {
  ...
  @Override
  public void onRemove(DynamicFieldSlot model, InterceptorContext context)
      throws InterceptorException {
    try {
      int count = modelService.countBySpecification(DynamicFieldTemplateSpecification
          .getDynamicFieldTemplateByDynamicFieldSlotUuid(model.getUuid()),
