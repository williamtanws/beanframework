...
public class ConfigurationDtoConverter extends AbstractDtoConverter<Configuration, ConfigurationDto> implements DtoConverter<Configuration, ConfigurationDto> {
