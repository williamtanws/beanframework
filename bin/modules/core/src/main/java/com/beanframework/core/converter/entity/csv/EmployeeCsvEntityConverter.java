...
@Component
public class EmployeeCsvEntityConverter implements EntityCsvConverter<EmployeeCsv, Employee> {

  protected static Logger LOGGER = LoggerFactory.getLogger(EmployeeCsvEntityConverter.class);
  ...
  private Employee convertToEntity(EmployeeCsv source, Employee prototype)
