...
public class DynamicFieldTemplateDtoConverter
    extends AbstractDtoConverter<DynamicFieldTemplate, DynamicFieldTemplateDto>
    implements DtoConverter<DynamicFieldTemplate, DynamicFieldTemplateDto> {
