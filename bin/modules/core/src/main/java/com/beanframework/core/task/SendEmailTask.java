...
public class SendEmailTask implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) {
    ...
    List<Email> processingEmails =
        (List<Email>) execution.getVariable(ProcessEmailTask.PROCESSING_EMAILS);
    ...
    for (Email email : processingEmails) {
      ...
      try {
        ...
        sendEmail(toRecipients, ccRecipients, bccRecipients, email.getSubject(), email.getText(),
            email.getHtml(), files.stream().toArray(File[]::new));
  ...
  private void sendEmail(String[] to, String[] cc, String[] bcc, String subject, String text,
