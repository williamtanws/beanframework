...
@Component
public class UserGroupPopulator extends AbstractPopulator<UserGroup, UserGroupDto>
    implements Populator<UserGroup, UserGroupDto> {
  ...
  public UserGroupAttributeDto populateUserGroupField(UserGroupAttribute source)
