...
public class AddressCsv extends GenericCsv {
  ...
  public String toString() {
    return "AddressCsv [id=" + id + ", streetName=" + streetName + ", streetNumber=" + streetNumber
        + ", postalCode=" + postalCode + ", town=" + town + ", countryId=" + countryId + "]";
  }
