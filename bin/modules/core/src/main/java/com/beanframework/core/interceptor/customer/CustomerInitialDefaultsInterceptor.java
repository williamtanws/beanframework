...
public class CustomerInitialDefaultsInterceptor
    extends AbstractInitialDefaultsInterceptor<Customer> {

  protected static Logger LOGGER =
      LoggerFactory.getLogger(CustomerInitialDefaultsInterceptor.class);
  ...
  @Override
  public void onInitialDefaults(Customer model, InterceptorContext context)
    ...
    try {
      ...
      String loginAttemptMaxDefault = configurationService
