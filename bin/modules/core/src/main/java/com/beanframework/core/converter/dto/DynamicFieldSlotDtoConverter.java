...
public class DynamicFieldSlotDtoConverter extends AbstractDtoConverter<DynamicFieldSlot, DynamicFieldSlotDto> implements DtoConverter<DynamicFieldSlot, DynamicFieldSlotDto> {
