...
@Component
public class EnumerationCsvEntityConverter
    implements EntityCsvConverter<EnumerationCsv, Enumeration> {

  protected static Logger LOGGER = LoggerFactory.getLogger(EnumerationCsvEntityConverter.class);
  ...
  private Enumeration convertToEntity(EnumerationCsv source, Enumeration prototype)
