...
public class RequestUtils extends CommonUtils {
  /**
   * @param parameterMap
   * @param key
   * @return
   ...
   * @return
   */
  public static Cookie addCookie(String contextPath, HttpServletResponse response, String name,
   ...
   * @param domain
   */
  public static void cancleCookie(String contextPath, HttpServletResponse response, String name,
      String domain) {
