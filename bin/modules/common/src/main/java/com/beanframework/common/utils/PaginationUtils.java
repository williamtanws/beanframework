...
//
// public static Map<String, Object> getPaginationParam(Model model, @RequestParam Map<String,
// Object> requestParams) {
// Map<String, Object> params = new HashMap<String, Object>();
//
// int page = isNotBlank(requestParams.get(PARAM)) ?
// Integer.valueOf(requestParams.get(PARAM).toString()) - 1 : 0;
// int size = isNotBlank(requestParams.get(PARAM_SIZE)) ?
// Integer.valueOf(requestParams.get(PARAM_SIZE).toString()) : DEFAULT_SIZE;
// Direction direction = isNotBlank(requestParams.get(PARAM_DIRECTION)) ?
// Direction.valueOf(requestParams.get(PARAM_DIRECTION).toString().toUpperCase()) : null;
// String properties = isNotBlank(requestParams.get(PARAM_PROPERTIES)) ?
// String.valueOf(requestParams.get(PARAM_PROPERTIES).toString().toUpperCase()) : null;
//
...
// }
//
// public static String getPaginationPath(String path, @RequestParam Map<String, Object>
// requestParams) {
//
// int page = isNotBlank(requestParams.get(PARAM)) ?
// Integer.valueOf(requestParams.get(PARAM).toString()) - 1 : 0;
...
//
// UriComponents paginationPath =
// UriComponentsBuilder.fromPath(path).queryParams(paginationParams).build();
//
// return paginationPath.toString();
// }
//
// public static String generatePath(String path, Map<String, String> additionalParams,
...
// }
//
// public static void setPaginationParams(Model model, @RequestParam Map<String, Object>
// requestParams) {
//
...
// }
//
// public static void setPaginationParams(RedirectAttributes redirectAttributes, @RequestParam
...
// redirectAttributes.addAttribute(PARAM_PROPERTIES,
// convertParamEncode(requestParams.get(PARAM_PROPERTIES)));
// redirectAttributes.addAttribute(PARAM_DIRECTION,
// convertParamEncode(requestParams.get(PARAM_DIRECTION)));
// }
//
