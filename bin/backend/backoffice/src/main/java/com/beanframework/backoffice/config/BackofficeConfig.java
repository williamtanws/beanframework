...
import com.beanframework.backoffice.security.CsrfHeaderFilter;
import com.beanframework.backoffice.security.SessionExpiredDetectingLoginUrlAuthenticationEntryPoint;

@Configuration
@EnableWebSecurity
@Order(2)
public class BackofficeConfig extends WebSecurityConfigurerAdapter {
