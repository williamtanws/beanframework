...
//	
//	@Override
//	public void deleteAllModuleUserRightByUserRightUuid(UUID uuid) throws BusinessException {
//		
//		modelService.remove(uuid, UserAuthority.class);
//	}
//
//	@Override
//	public void deleteAllModuleUserPermissionByUserPermissionUuid(UUID uuid) throws BusinessException {		
//		
