...
public class UserPermissionResource extends AbstractResource {
	...
	@PreAuthorize(UserPermissionPreAuthorizeEnum.HAS_READ)
	@RequestMapping(value = UserPermissionWebConstants.Path.Api.PERMISSION, method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	...
	@PreAuthorize(UserPermissionPreAuthorizeEnum.HAS_READ)
	@RequestMapping(value = UserPermissionWebConstants.Path.Api.PERMISSION_HISTORY, method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
