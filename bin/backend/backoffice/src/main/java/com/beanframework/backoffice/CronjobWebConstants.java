...
public interface CronjobWebConstants {
	...
	public interface Path {
		...
		public interface Api {
			...
			public static final String CRONJOB_CHECKJOBGROUPNAME = "${path.api.cronjob.checkjobgroupname}";
			public static final String CRONJOB_CHECKJOBCLASS = "${path.api.cronjob.checkjobclass}";
			public static final String CRONJOB_CHECKCRONEXPRESSION = "${path.api.cronjob.checkcronexpression}";
		}
