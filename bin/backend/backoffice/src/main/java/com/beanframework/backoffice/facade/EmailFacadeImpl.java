...
public class EmailFacadeImpl implements EmailFacade {
	...
	@Override
	public Page<EmailDto> findPage(Specification<EmailDto> specification, PageRequest pageable) throws Exception {
		Page<Email> page = modelService.findEntityPage(specification, pageable, Email.class);
	...
	public EmailDto findOneByUuid(UUID uuid) throws Exception {
		Email entity = modelService.findOneEntityByUuid(uuid, Email.class);
		return modelService.getDto(entity, EmailDto.class);
	}

	@Override
	public EmailDto findOneByProperties(Map<String, Object> properties) throws Exception {
		Email entity = modelService.findOneEntityByProperties(properties, Email.class);
		return modelService.getDto(entity, EmailDto.class);
	}
