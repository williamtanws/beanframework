...
public static final String PAGINATION = "pagination";
	...
	public interface Path {
		public static final String BACKOFFICE = "${cockpit.webroot}";
		public static final String BACKOFFICE_API = "${cockpit.api}";
	...
	public interface Authority {
		public static final String BACKOFFICE = "${module.cockpit.authority}";
