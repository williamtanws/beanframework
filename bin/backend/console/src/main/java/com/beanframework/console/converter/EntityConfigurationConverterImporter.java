...
@Component
public class EntityConfigurationConverterImporter implements EntityConverter<ConfigurationCsv, Configuration> {

	protected static Logger LOGGER = LoggerFactory.getLogger(EntityConfigurationConverterImporter.class);
