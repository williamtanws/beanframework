...
@Component
public class EntityEmployeeConverterImporter implements EntityConverter<EmployeeCsv, Employee> {

	protected static Logger LOGGER = LoggerFactory.getLogger(EntityEmployeeConverterImporter.class);
