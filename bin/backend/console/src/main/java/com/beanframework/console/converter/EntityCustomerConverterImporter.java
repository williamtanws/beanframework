...
@Component
public class EntityCustomerConverterImporter implements EntityConverter<CustomerCsv, Customer> {

	protected static Logger LOGGER = LoggerFactory.getLogger(EntityCustomerConverterImporter.class);
