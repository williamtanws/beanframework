...
@Component
public class ImportEntityUserPermissionConverter implements EntityConverter<UserPermissionCsv, UserPermission> {

	protected static Logger LOGGER = LoggerFactory.getLogger(ImportEntityUserPermissionConverter.class);
