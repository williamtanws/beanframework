...
@Component
public class EntityCsvCustomerConverter implements EntityCsvConverter<CustomerCsv, Customer> {
	...
	public Customer convert(CustomerCsv source) throws ConverterException {
		...
		try {
			...
			if (StringUtils.isNotBlank(source.getId())) {
				...
				Customer prototype = modelService.findByProperties(properties, Customer.class);
