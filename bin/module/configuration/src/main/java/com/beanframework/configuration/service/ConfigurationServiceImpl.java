...
public class ConfigurationServiceImpl implements ConfigurationService {
	...
	@Override
	public <T> Page<Configuration> findEntityPage(DataTableRequest<T> dataTableRequest) throws Exception {
		return modelService.findEntityPage(dataTableRequest.getSpecification(), dataTableRequest.getPageable(), false, Configuration.class);
	}
