...
@Component
public class ImexFullPopulator extends AbstractPopulator<Imex, ImexDto> implements Populator<Imex, ImexDto> {

	protected static Logger LOGGER = LoggerFactory.getLogger(ImexFullPopulator.class);
