...
@Component
public class VendorFullPopulator extends AbstractPopulator<Vendor, VendorDto> implements Populator<Vendor, VendorDto> {

	protected static Logger LOGGER = LoggerFactory.getLogger(VendorFullPopulator.class);
