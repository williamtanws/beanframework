...
@Component
public class MediaFullPopulator extends AbstractPopulator<Media, MediaDto> implements Populator<Media, MediaDto> {

	protected static Logger LOGGER = LoggerFactory.getLogger(MediaFullPopulator.class);
