...
@Component
public class UserRightFieldHistoryPopulator extends AbstractPopulator<UserRightField, UserRightFieldDto> implements Populator<UserRightField, UserRightFieldDto> {

	protected static Logger LOGGER = LoggerFactory.getLogger(UserRightFieldHistoryPopulator.class);
