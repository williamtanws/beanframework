...
@Component
public class VendorHistoryPopulator extends AbstractPopulator<Vendor, VendorDto> implements Populator<Vendor, VendorDto> {

	protected static Logger LOGGER = LoggerFactory.getLogger(VendorHistoryPopulator.class);
