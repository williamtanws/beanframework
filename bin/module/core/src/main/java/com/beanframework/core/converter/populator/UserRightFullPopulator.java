...
@Component
public class UserRightFullPopulator extends AbstractPopulator<UserRight, UserRightDto> implements Populator<UserRight, UserRightDto> {

	protected static Logger LOGGER = LoggerFactory.getLogger(UserRightFullPopulator.class);
