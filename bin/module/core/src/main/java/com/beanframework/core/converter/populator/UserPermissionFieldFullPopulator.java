...
@Component
public class UserPermissionFieldFullPopulator extends AbstractPopulator<UserPermissionField, UserPermissionFieldDto> implements Populator<UserPermissionField, UserPermissionFieldDto> {

	protected static Logger LOGGER = LoggerFactory.getLogger(UserPermissionFieldFullPopulator.class);
