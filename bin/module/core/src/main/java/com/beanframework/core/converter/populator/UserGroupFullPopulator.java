...
@Component
public class UserGroupFullPopulator extends AbstractPopulator<UserGroup, UserGroupDto> implements Populator<UserGroup, UserGroupDto> {

	protected static Logger LOGGER = LoggerFactory.getLogger(UserGroupFullPopulator.class);
