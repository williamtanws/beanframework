...
@Component
public class WorkflowBasicPopulator extends AbstractPopulator<Workflow, WorkflowDto> implements Populator<Workflow, WorkflowDto> {

	protected static Logger LOGGER = LoggerFactory.getLogger(WorkflowBasicPopulator.class);
