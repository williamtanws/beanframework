...
@Component
public class DynamicFieldSlotHistoryPopulator extends AbstractPopulator<DynamicFieldSlot, DynamicFieldSlotDto> implements Populator<DynamicFieldSlot, DynamicFieldSlotDto> {
