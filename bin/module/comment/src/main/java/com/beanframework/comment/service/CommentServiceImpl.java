...
public class CommentServiceImpl implements CommentService {
	...
	@Override
	public <T> Page<Comment> findEntityPage(DataTableRequest<T> dataTableRequest) throws Exception {
		return modelService.findEntityPage(dataTableRequest.getSpecification(), dataTableRequest.getPageable(), false, Comment.class);
	}
